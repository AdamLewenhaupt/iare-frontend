...
var createIcon, createIcons, dimFactory, elbow, lightFactory;

elbow = function(d, i) {
  if (d.target.children === void 0) {
...
$(function() {
  var height, i, loc, margin, parts, svg, tree, url, width;
  ...
  if (loc === "d3testing.html") {
    ...
    i = 0;
    tree = d3.layout.tree().size([height, width]).nodeSize([60]);
