...
var createIcon, createIcons, dimFactory, elbow, isCluster, lightFactory, menuSetup;

menuSetup = function(names) {
  var k, len, name, results;
  results = [];
...
$(function() {
  var i, margin, screenHeight, screenWidth, svg, tree, width;
